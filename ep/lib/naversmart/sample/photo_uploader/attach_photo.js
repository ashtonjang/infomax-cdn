	...
	function html5Upload() {
	    ...
	    sUploadURL = '/apis/board/uploaddata'; //upload URL
	...
	function callFileUploader() {
	    console.error(jindo.$("uploadInputBox"));
	    oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"), {
	        sUrl: '/apis/board/uploaddata', //샘플 URL입니다.
	...
	jindo.$Ajax.prototype.request = function(oData) {
	    $.find('input[type="file"]').prop('files', oData);
